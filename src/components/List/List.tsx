...
import { useExpose, useRect, useEventListener, useScrollParent } from '~/hooks'
import { type ListExpose, listProps } from './type'
  ...
  setup(props, { emit, slots }) {
    ...
    const check = () => {
      nextTick(() => {
        ...
        isReachEdge =
          placeholderRect.bottom - scrollParentRect.bottom <= offset.value
        if (isReachEdge) {
          loading.value = true
